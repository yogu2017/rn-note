  ...
  cameraAction = () =>{
    ...
    _save(){
      ...
      let params = {
          ...
          note_areaname :note_areaname,
          note_area_lon:note_area_lon,
          note_area_lat:note_area_lat,
          note_id:note_id
      };
      var url = Fn.requestUrl+'notes/Edit';
    ...
    componentDidMount(){
      ...
      this.setState({
        color:data[0].note_color,
        content:data[0].note_content,
        state:options[data[0].note_state],
        note_id:data[0].note_id
      })
      if (data[0].note_img!='') {
        this.setState({
          show_pic:true,
          note_img:Fn.requestUrl+data[0].note_img,
          img_url:data[0].note_img
        })
      }
      if (data[0].note_state==3) {
        this.setState({
          state_index:'3',
          map_select:data[0].note_areaname,
          lon:data[0].note_area_lon,
          lat:data[0].note_area_lat,
        })
      }
    }
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        right={true}
        right_icon={require('../images/save.png')}
        ...
        <View style={styles.add_txt}>
          ...
          <View style={styles.pic_row}>
            {this.state.show_pic?(<View style={styles.add_new_pic}>
                ...
                <Image style={styles.show_pic} source={{uri:this.state.note_img}} />
            </View>):null}
            <TouchableOpacity
             activeOpacity={0.9}
